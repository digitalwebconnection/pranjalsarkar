  ...
  return (
    <div className="bg-[#000001] text-white min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1 pt-32 pb-20 px-6 md:px-12 max-w-4xl mx-auto w-full">
        <h1 className="text-3xl md:text-5xl font-serif font-bold mb-4 text-white">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-[15px] md:text-[16px]">
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">1. Who This Policy Applies To</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">2. What Information Is Collected</h3>
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">2.1 Information You Provide Directly</h4>
          ...
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">2.2 Information Collected Automatically</h4>
          ...
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">2.3 Decision Audit Tools</h4>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">3. How This Information Is Used</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">4. WhatsApp Communication</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">5. Email Communication</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">6. Cookies</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">7. Third-Party Services</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">8. Data Storage and Security</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">9. Your Rights</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">10. Children</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">11. Links to Other Websites</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">12. Changes to This Policy</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">13. Contact</h3>

  ...
  return (
    <div className="bg-[#000001] text-white min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1 pt-32 pb-20 px-6 md:px-12 max-w-4xl mx-auto w-full">
        <h1 className="text-3xl md:text-5xl font-serif font-bold mb-4 text-white">Refund Policy</h1>
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-[15px] md:text-[16px]">
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">1. Masterclasses and Workshops</h3>
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">1.1 Eligibility for Refund</h4>
          ...
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">1.2 How to Request a Refund</h4>
          ...
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">1.3 Missed Sessions</h4>
          ...
          <h4 className="text-lg font-bold text-gray-100 mt-6 mb-3">1.4 Session Cancelled by Pranjal Sarkar</h4>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">2. Early Bird Pricing</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">3. Corporate Registrations</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">4. Free Tools and Resources</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">5. Digital Products</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">6. Payment Processing</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">7. GST</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">8. Changes to This Policy</h3>
          ...
          <h3 className="text-xl font-serif font-bold text-white mt-10 mb-4">9. Contact</h3>

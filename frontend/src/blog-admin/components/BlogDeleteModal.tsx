...
export const BlogDeleteModal: React.FC<BlogDeleteModalProps> = ({ isOpen, isDeleting, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-white rounded-sm shadow-2xl w-full max-w-sm overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200">
        <div className="p-6 text-center">
          ...
          <h3 className="text-xl font-black text-slate-800 mb-2">Delete Blog Post</h3>

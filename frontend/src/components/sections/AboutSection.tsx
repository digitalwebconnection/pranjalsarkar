    ...
    <section id="about" className="relative py-12 md:py-14 overflow-hidden border-b border-white/8 bg-[#000001]">
      ...
      >
        ...
        <motion.div className="flex flex-col text-center justify-center mb-12" variants={itemVariants}>
          ...
          <h2 className="font-serif font-bold text-4xl md:text-5xl lg:text-5xl leading-tight tracking-tight text-white mb-4 text-center">
          ...
          <p className="text-gray-200 text-base md:text-xl max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center  lg:pl-6">
            ...
            <motion.div variants={itemVariants} className="mb-2">
              <h3 className="text-3xl font-serif font-bold text-white mb-2">The Gap I Kept Seeing</h3>
              <p className="text-gray-300 text-sm text-justify md:text-[14px] lg:text-[16px] leading-6  font-sans">
              ...
              <br />
              <p className="text-gray-300 text-sm md:text-[15px] lg:text-[16px] leading-6 mb-4 font-sans">
              ...
              <h3 className="text-3xl font-serif font-bold text-white mb-2">Pranjal Sarkar</h3>
              <p className="text-gray-300 text-sm md:text-[15px] lg:text-[16px] leading-6 font-sans">
            ...
            <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-2" variants={itemVariants}>
              ...
              <div className="relative flex flex-col text-center bg-[#0a0c10] border border-white/20 rounded-lg shadow-[0_0_30px_rgba(0,128,199,0.3)] overflow-hidden">
                ...
                <div className="relative z-10 p-3 md:p-5 border-b border-white/20 flex-1 flex flex-col justify-center">
                  <div className="text-5xl font-serif md:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-b from-[rgba(24,37,226,1)] to-[#006eff] drop-shadow-[0_0_15px_rgba(24,37,226,0.6)] mb-1">20</div>
              ...
              <div className="relative flex flex-col text-center bg-[#0a0c10] border border-white/20 rounded-lg shadow-[0_0_30px_rgba(0,128,199,0.3)] overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,168,255,0.15)_0%,transparent_70%)] pointer-events-none" />
                <div className="relative z-10 p-3 md:p-5 border-b border-white/20 flex-1 flex flex-col justify-center">
                  <div className="text-5xl font-serif md:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-b from-[rgba(24,37,226,1)] to-[#006eff] drop-shadow-[0_0_15px_rgba(24,37,226,0.6)] mb-2">03</div>
              ...
              <div className="relative flex flex-col text-center bg-[#0a0c10] border border-white/20 rounded-lg shadow-[0_0_30px_rgba(0,128,199,0.3)] overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,168,255,0.15)_0%,transparent_70%)] pointer-events-none" />
                <div className="relative z-10 p-3 md:p-5 border-b border-white/20 flex-1 flex flex-col justify-center">
                  <div className="text-5xl font-serif md:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-b from-[rgba(24,37,226,1)] to-[#006eff] drop-shadow-[0_0_15px_rgba(24,37,226,0.6)] mb-2">04</div>
                  <div className="text-white text-sm md:text-base">Organizations</div>
                </div>
                <div className="relative z-10 p-3 md:p-4 flex-1">
                  <div className="text-xs text-gray-300 leading-snug">Experience Across Small, Mid-Sized and Large Enterprises</div>
                </div>
              </div>
              ...
              <div className="relative flex flex-col text-center bg-[#0a0c10] border border-white/20 rounded-lg shadow-[0_0_30px_rgba(0,128,199,0.3)] overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,168,255,0.15)_0%,transparent_70%)] pointer-events-none" />
                <div className="relative z-10 p-3 md:p-5 border-b border-white/20 flex-1 flex flex-col justify-center">
                  <div className="text-5xl md:text-7xl font-serif font-bold text-transparent bg-clip-text bg-linear-to-b from-[rgba(24,37,226,1)] to-[#006eff] drop-shadow-[0_0_15px_rgba(24,37,226,0.6)] mb-2">10</div>
      ...
      >
        ...
        <div className="max-w-full mx-auto flex flex-col items-center mt-6 md:mt-8 h-150 ">
          {/* Video Placeholder */}
          <div

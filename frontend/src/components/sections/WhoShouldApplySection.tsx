      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#ffffff] text-sm md:text-base lg:text-lg leading-relaxed max-w-6xl mx-auto text-center font-normal mt-3">
            AI Product Leadership Studio is designed only for experienced Product Managers preparing to operate at the Director level. The discussions, simulations, executive case studies and Product Leadership Exposure assume a certain level of experience. If you're at an earlier stage of your career, you'll gain far more value by building a stronger Product Management foundation first. Please review the criteria below before submitting your application.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          ...
          {/* Should Apply Card */}
          <div className="group relative rounded-xl p-px bg-linear-to-br from-[#002ec7]/90 via-[#002ec7]/20 to-transparent shadow-[-20px_-20px_60px_rgba(0,136,255,0.4),10px_10px_30px_rgba(0,136,255,0.3)] transition-all duration-300 hover:shadow-[-30px_-30px_80px_rgba(0,136,255,0.6),15px_15px_40px_rgba(0,136,255,0.4)]">
            <div className="relative h-full w-full bg-[#03060a] rounded-[15px] p-6 md:p-8 flex flex-col overflow-hidden z-10">
              ...
              <div className="space-y-5 relative z-10">
                {shouldApply.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-4 group/item">
                    <div className="mt-1 shrink-0 w-6 h-6 rounded-full bg-[#0075ff]/30 flex items-center justify-center border border-[#00a8ff]/60 shadow-[0_0_15px_rgba(0,168,255,0.5)] transition-all duration-300 group-hover/item:shadow-[0_0_20px_rgba(0,168,255,0.8)] group-hover/item:scale-110">
                      <Check size={14} className="text-[#00a8ff] drop-shadow-[0_0_5px_rgba(0,168,255,1)]" />
                    </div>
          ...
          <div className="group relative rounded-xl p-px bg-linear-to-bl from-red-600/80 via-red-600/20 to-transparent shadow-[20px_-20px_60px_rgba(239,68,68,0.3),-10px_10px_30px_rgba(239,68,68,0.2)] transition-all duration-300 hover:shadow-[30px_-30px_80px_rgba(239,68,68,0.5),-15px_15px_40px_rgba(239,68,68,0.3)]">
            <div className="relative h-full w-full bg-[#03060a] rounded-[15px] p-6 md:p-8 flex flex-col overflow-hidden z-10">
              ...
              <div className="space-y-5 relative z-10">
                {shouldNotApply.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-4 group/item">
                    <div className="mt-1 shrink-0 w-6 h-6 rounded-full bg-red-500/20 flex items-center justify-center border border-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.5)] transition-all duration-300 group-hover/item:shadow-[0_0_25px_rgba(239,68,68,0.8)] group-hover/item:scale-110">
                      <X size={14} className="text-red-400 drop-shadow-[0_0_8px_rgba(239,68,68,0.9)]" />
                    </div>
            ...
            <div className="relative bg-[#060a14] rounded-xl p-4 md:p-6 flex flex-col md:flex-row gap-6 items-start md:items-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-200 text-sm leading-relaxed">
                  This is an application-only program. We keep each cohort with very selective product managers to ensure every participant receives meaningful interaction, executive feedback, peer learning and an immersive leadership experience. Meeting the eligibility criteria does not automatically guarantee admission. We review every application to ensure the Studio remains valuable for everyone in the cohort.
                </p>
              </div>
            </div>
          </div>

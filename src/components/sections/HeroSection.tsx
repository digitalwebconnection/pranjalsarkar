      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-5 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-start mb-8">
                <a
                  href="#contact"
                  className="inline-flex items-center gap-1.5 px-7 py-3.5 rounded-md text-[#080808] text-[14px] font-bold tracking-wide no-underline transition-all duration-200 bg-[#0080C7] hover:bg-[#009CEE] hover:shadow-[0_0_24px_rgba(0,128,199,0.8)] hover:-translate-y-0.5"
                >
                  Apply for Cohort 2 <span className="text-[14px] font-bold">→</span>
                </a>
                <a
                  href="#program"
                  className="inline-flex items-center gap-1.5 px-7 py-3.5 rounded-md text-white text-[14px] font-semibold tracking-wide no-underline transition-all duration-200 border border-white/8 hover:border-white/20 hover:bg-white/8 hover:-translate-y-0.5"
                >
                  Explore Program
                </a>
              </div>
          ...
          <div className="lg:col-span-6 mt-14   flex justify-center lg:justify-end relative">
            <div className="relative w-full max-w-95 lg:max-w-120 aspect-3.5/4 overflow-hidden ">
              <img
                src={pranjalsarkar}
